      ...
      <Stack direction={{ base: 'column', md: 'row' }} shadow={'2xl'}>
        <Flex flex={1}>
          <Image
            ...
            objectFit={'cover'}
            src={
              'https://res.cloudinary.com/hello-tickets/image/upload/c_limit,f_auto,q_auto,w_768/v1673299422/post_images/paris-125/tours-paris/brooke-cagle-tLG2hcpITZE-unsplash_Cropped.jpg'
            }
          />
        </Flex>
        <Flex p={4} flex={2} align={'center'} justify={'center'}>
          <VStack spacing={5} w={'full'}>
            <Icon as={NotificationIcon} w={24} h={24} />
            <VStack align={'center'} spacing={2} maxW={'full'}>
              <Heading
